window.onload = () => {
  ...
  class Game {
    ...
    init() {
      ...
      this.canvas.style.border = "15px solid #1ab385";
    ...
    launch() {
      this.snakee = new Snake("right", [6,4], [5,4], [4,4], [3,4]);
  ...
  class Snake {
    ...
    checkCollision = function(widthInBlocks,heightInBlocks) {
  ...
  isEatingApple = function (appleToEat) {
  ...
  class Drawing {
    static gameOver(ctx, centreX, centreY) {
      ...
      ctx.strokeText("Clic on space to play again", centreX, centreY - 120);
      ctx.fillText("Clic on space to play again", centreX, centreY - 120);
      ctx.restore();
    };
